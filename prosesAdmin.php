...
$emailGuru = $_POST['username'];
$passwordGuru = $_POST['pass'];

$sql1 = "select * from teachers where email = '$emailGuru' and password = '$passwordGuru'";
    ...
    <div class="limiter">
        <div class="container-login100" style="background-image: url('images/bg-01.jpg');">
            <div class="wrap-login100 p-t-30 p-b-50">
                ...
                <form class="login100-form validate-form p-b-33 p-t-5" action="prosesAdmin.php" method="POST">
