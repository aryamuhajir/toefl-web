...
$student_roll_number = $_POST['noUjian'];
...
if (mysqli_num_rows($result) > 0) {      //Creds arezz
    ...
    echo "<script>alert('No Ujian atau Password salah');</script>";
}
    ...
    <div class="limiter">
        <div class="container-login100" style="background-image: url('images/bg-01.jpg');">
            <div class="wrap-login100 p-t-30 p-b-50">
                ...
                <form class="login100-form validate-form p-b-33 p-t-5" action="proses.php" method="POST">

                    <div class="wrap-input100 validate-input" data-validate="Enter username">
                        <input class="input100" type="text" name="noUjian" placeholder="No. Ujian">
